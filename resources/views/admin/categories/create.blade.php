            ...
            <form action="{{ route('admin.categories.store') }}" method="POST" role="form"
                ...
                <div class="tile-body">
                    ...
                    <div class="form-group">
                        <div class="form-check">
                            <label class="form-check-label">
                                <input class="form-check-input" type="checkbox" id="featured" name="featured" />Danh mục
                                đặc biệt
                            </label>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="form-check">
                            <label class="form-check-label">
                                <input class="form-check-input" type="checkbox" id="menu" name="menu" />Hiển thị trên
                                menu
                            </label>
                        </div>
                    </div>
