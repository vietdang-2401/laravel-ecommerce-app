        ...
        <div class="row">
                            ...
                            <article class="p-5">
                                ...
                                <div class="mb-3">
                                    ...
                                    <var class="price h3 text-danger">
                                        <span class="num" id="productPrice">{{ $product->sale_price }}</span><span
                                            class="currency">{{ config('settings.currency_symbol') }}</span>
                                        <del class="price-old"> {{$product->price }}{{
                                            config('settings.currency_symbol') }}</del>
                                    </var>
                                    @else
                                    <var class="price h3 text-success">
                                        <span class="num" id="productPrice">{{ $product->price }}</span><span
                                            class="currency">{{ config('settings.currency_symbol') }}</span>
                                    </var>
                                    @endif
                                </div>
                                            ...
                                            <dl class="dlist-inline">
                                                ...
                                                <dd>
                                                    <select class="form-control form-control-sm option"
                                                        style="width:180px;" name="{{ strtolower($attribute->name ) }}">
                                                        <option data-price="0" value="0"> Select a {{ $attribute->name
                                                            }}</option>
                                            ...
                                            <dl class="dlist-inline">
                                                ...
                                                <dd>
                                                    <input class="form-control" type="number" min="1" value="1"
                                                        max="{{ $product->quantity }}" name="qty" style="width:70px;">
            ...
            <div class="col-md-12">
                <article class="card mt-4">
                    <h3 class="card-header">Mô tả sản phẩm</h3>
                    <div class="card-body">
                        {!! $product->description !!}
                    </div>
                </article>
