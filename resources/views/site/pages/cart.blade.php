...
<section class="section-pagetop bg-dark">
    <div class="container clearfix">
        <h2 class="title-page">Thông tin giỏ hàng</h2>
    </div>
</section>
    ...
    <div class="container">
        ...
        <div class="row">
                    ...
                    <table class="table table-hover shopping-cart-wrap">
                        <thead class="text-muted">
                            <tr>
                                ...
                                <th scope="col" class="text-right" width="200">Hành động</th>
                            </tr>
                        </thead>
                        <tbody>
            ...
            <aside class="col-sm-3">
                <a href="{{ route('checkout.cart.clear') }}" class="btn btn-danger btn-block mb-4">Xóa giỏ hàng</a>
                <p class="alert alert-success">Đơn hàng chưa đủ điều kiện áp dụng khuyến mãi. Vui lòng mua thêm để áp
                    dụng. </p>
                <dl class="dlist-align h4">
                    <dt>Tổng:</dt>
                    <dd class="text-right"><strong>{{ config('settings.currency_symbol') }}{{ \Cart::getSubTotal()
                            }}</strong></dd>
                </dl>
                <hr>
                ...
                <a href="{{route('checkout.index')}}" class="btn btn-success btn-lg btn-block">Thanh toán</a>
            </aside>
        </div>
    </div>
</section>
